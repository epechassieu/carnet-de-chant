...
// Clé de signature de release : fichier local, jamais committé (voir .gitignore).
// Absent en CI -> les builds non signées (debug, `./gradlew build`) continuent de fonctionner.
